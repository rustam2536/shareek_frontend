        ...
        <>
            <div>
                ...
                <div class="layout-wrapper landing">
                    <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar bg-light" id="navbar">
                        <div class="container-fluid custom-container">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                                    <li class="nav-item">
                                        <Link to={'/home'} class="nav-link fs-14 active" href="#hero">Home</Link>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="">
                                    <Link to="/login" class="btn btn-soft-primary"><i class="ri-user-3-line align-bottom me-1"></i> Login & Register</Link>
                                </div>
                            </div>
